...
public class Flat implements Serializable, Comparable{
    ...
    public Flat(String name, long id, Coordinates coordinates1, Double area, long numberOfRooms, Furnish furnish, View view, Transport transport, House house, String login) throws AllException, IOException {
        ...
        this.area = area; if (area>10000000) throw new AllException("Ошибка, площвдь квартиры не может превышать 10000000 м^2");
    ...
    public long getAgeOfPerson() {return numberOfRooms;}
    ...
    public Double getHeight() {return area;};
    public void setArea(Double area) {this.area=area;}

    public Furnish getFurnish(){
        return furnish;
    }
    public Furnish getColor1(){
        return furnish;
    }
    ...
    public String getJob() {return house.getHouseName();}
    public Integer getHouseAge() {return house.getYear();}
    public Integer getWorkExperience() {return house.getYear();}
    public Integer getLifts() {return house.getNumberOfLifts();}
    public Integer getSalary() {return house.getNumberOfLifts();}
