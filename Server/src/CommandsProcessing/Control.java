        ...
        try{
            ...
            switch (sarray[0]) {
                ...
                case "remove_lower":
                    ...
                    break;
                case "countByAge":
                    CommandToObjectServer cbr = new CommandToObjectServer("countByAge", comm.countByRooms(g));
                ...
                case "history":
                    ...
                    new ServerAnswerNew();
                    break;
                case "remove_by_workExperience":
                    CommandToObjectServer rbha  = new CommandToObjectServer("remove_by_workExperience", comm.removeByHouseAge(g));
